...
## Plato
Owns S1A Scoped Ideal Model. Defines ideal form, product value, v1 boundary, non-goals, platforms, deployment, integrations, data ownership, trust, privacy, compliance, scale, and non-negotiables.

## Aristotle
Owns S2 Structural Design. Derives architecture from Plato's scoped ideal.
