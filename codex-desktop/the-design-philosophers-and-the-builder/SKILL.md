...
description: >-
  Windows 11 Codex Desktop skill for designing software from scratch with a bounded Mealy-style workflow using philosopher agents, Builder 1986, Feature Branch Workflow backed by Git worktrees, one-task-at-a-time worktree slicing, TOML handoffs, security review, patch planning, and smallest-safe-slice implementation.
---
